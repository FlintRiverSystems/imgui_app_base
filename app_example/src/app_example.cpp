...
void app_example::_render_ui()
{
	...
	// 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
	{
		...
		ImGui::ColorEdit3("clear color", (float*)&_bg_color); // Edit 3 floats representing a color
		...
		ImGui::Text("Application average %6.3f ms/frame (%5.1f FPS)", 1000.0f / ImGui::GetIO().Framerate, ImGui::GetIO().Framerate);
		ImGui::End();
	}
